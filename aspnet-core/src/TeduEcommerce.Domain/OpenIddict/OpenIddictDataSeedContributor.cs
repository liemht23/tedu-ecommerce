...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    private async Task CreateScopesAsync()
    {
        ...
        if (await _openIddictScopeRepository.FindByNameAsync("TeduEcommerce.Admin") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor
            {
                Name = "TeduEcommerce.Admin",
                DisplayName = "TeduEcommerce Admin API",
                Resources = { "TeduEcommerce.Admin" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        //Admin Client
        var adminWebClientId = configurationSection["TeduEcommerce_Admin:ClientId"];
